...
import { useGetBukuDipinjamPustakawan } from '@/hooks/fetchHooks/pustakawanHooks/bukuHooks'

const PustakawanBukuDipinjamPage = () => {

  const { isLoading, bukuDipinjam, ratioBukuDipinjam, statsBukuPinjam } = useGetBukuDipinjamPustakawan()
