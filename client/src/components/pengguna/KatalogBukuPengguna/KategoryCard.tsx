    ...
    return (
        <>
            {data.map((item:any, index:number) => {
                ...
                return (
                    <CarouselItem className="basis-1/6 flex">
                        <div key={index} className='w-full flex flex-col items-center justify-center p-4 rounded-xl border hover:border-primary duration-150 ease-in-out'>
