...
const Diterima = () => {
    return (
        <h3 className="w-full text-center bg-primary  self-center py-1 mt-4 rounded text-sm text-white">Diajukan</h3>
    )
}

const Dikembalikan = () => {
    return (
        <h3 className="w-full text-center bg-secondary  self-center py-1 mt-4 rounded text-sm text-white">Diajukan</h3>
    )
}

const Terlambat = () => {
    return (
        <h3 className="w-full text-center bg-destructive  self-center py-1 mt-4 rounded text-sm text-white">Diajukan</h3>
    )
}
