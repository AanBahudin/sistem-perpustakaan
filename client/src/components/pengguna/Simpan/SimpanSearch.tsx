  ...
  return (
    <section id="bookSearch" className="w-full flex items-center h-fit gap-x-2 justify-center mb-10">
      <main className="w-2/3 flex items-center justify-stretch border rounded-lg bg-secondary">
        ...
        <Input ref={searchRef} defaultValue={search} onChange={handleSearch} className="!bg-transparent border-none rounded-none px-4 selection:text-white focus:outline-none focus:ring-0 focus-visible:ring-0" placeholder="Temukan buku berdasarkan judul" />
      </main>
