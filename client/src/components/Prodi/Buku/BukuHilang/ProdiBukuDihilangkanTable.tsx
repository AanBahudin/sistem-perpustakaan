...
import { StatusPembayaranBadge } from "@/components/Pustakawan/Pengajuan/SemuaPengembalian/TabelSemuaPengembalian"
import ProdiTableDropdownMenu from "../ProdiTableDropdownMenu"


const ProdiBukuDihilangkanTable = ({dataBuku} : {dataBuku: any}) => {
...
export default ProdiBukuDihilangkanTable