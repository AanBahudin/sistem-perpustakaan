...
const CallToAction : React.FC = () => {
  return (
    <Container className='p-14  dark:bg-[url("/images/Sprinkle.svg")] bg-cover lg:p-20 flex-col shadow-2xl flex items-center justify-center bg-primary-foreground rounded-2xl'>
