        ...
        <Card className="p-6">
            <CardContent>
              <div className="w-full flex gap-x-4">
                  <div className="bg-muted w-12 h-12 rounded-full flex items-center justify-center">{item.name[0]}</div>
                  <main>
                      <h4 className="font-semibold">{item.name}</h4>
                      <p className="text-muted-foreground text-xs ">{item.position}</p>
                  </main>
              </div>
              <p  className="text-muted-foreground mt-4 text-md">{item.message}</p>
            </CardContent>
          </Card>
        </CarouselItem>
      ))}
