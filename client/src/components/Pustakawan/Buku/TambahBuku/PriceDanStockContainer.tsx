    ...
    <section className='w-full p-4 rounded-xl bg-muted dark:bg-accent/10'>
      ...
      <main className='w-full flex items-center justify-between gap-x-4'>
        <div className='w-1/2 flex flex-col gap-y-1 mb-2'>
          ...
          <Input name='hargaGanti' id='hargaGanti' required type='number' inputMode='numeric' className='w-full !text-xs placeholder:text-xs border dark:border-none' placeholder='Masukan dalam jumlah rupiah' />
        </div>
        ...
        <div className='w-1/2 flex flex-col gap-y-1 mb-2'>
          ...
          <Input name='stok' id='stok' type='number' required className='w-full !text-xs placeholder:text-xs border dark:border-none' placeholder='10' />
        </div>
      </main>
