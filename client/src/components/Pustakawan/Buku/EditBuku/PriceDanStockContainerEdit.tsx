...
const PriceDanStockContainerEdit = ({buku} : {buku: any}) => {
    ...
    <section className='w-full p-4 rounded-xl bg-accent/10'>
      ...
      <main className='w-full flex items-center justify-between gap-x-4'>
        <div className='w-1/2 flex flex-col gap-y-1 mb-2'>
          ...
          <Input defaultValue={buku.hargaGanti} name='hargaGanti' id='hargaGanti' required type='number' inputMode='numeric' className='w-full !text-xs placeholder:text-xs border-none' placeholder='Masukan dalam jumlah rupiah' />
        </div>
        ...
        <div className='w-1/2 flex flex-col gap-y-1 mb-2'>
          ...
          <Input defaultValue={buku.stok} name='stok' id='stok' type='number' required className='w-full !text-xs placeholder:text-xs border-none' placeholder='10' />
        </div>
      </main>
      ...
      <main className='w-full flex items-center justify-between gap-x-4'>
        <div className='w-1/2 flex flex-col gap-y-1 mb-2'>
          ...
          <Select name='status' required  defaultValue={buku.status}>
...
export default PriceDanStockContainerEdit