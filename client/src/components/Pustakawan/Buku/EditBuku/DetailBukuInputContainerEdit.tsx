...
const DetailBukuInputContainerEdit = ({buku} : {buku: any}) => {
    ...
    <section className='w-full p-4 rounded-xl bg-accent/10'>
      ...
      <main className='w-full flex items-center justify-between gap-x-4'>
        <div className='w-1/2 flex flex-col gap-y-1 mb-2'>
          ...
          <Input defaultValue={buku.ISBN} name='ISBN' id='ISBN' required type='text' inputMode='numeric' className='w-full selection:text-white !text-xs placeholder:text-xs border-none' placeholder='240238409234' />
        </div>
        ...
        <div className='w-1/2 flex flex-col gap-y-1 mb-2'>
          ...
          <Select name='tahunTerbit'  defaultValue={buku.tahunTerbit.toString()}> 
      ...
      <main className='w-full flex items-center justify-between gap-x-4'>
        <div className='w-1/2 flex flex-col gap-y-1 mb-2'>
          ...
          <Input defaultValue={buku.jumlahHalaman} name='jumlahHalaman' id='jumlahHalaman' required className='w-full !text-xs placeholder:text-xs border-none' placeholder='Total Halaman' />
        </div>
        ...
        <div className='w-1/2 flex flex-col gap-y-1 mb-2'>
          ...
          <Select name='bahasa' required defaultValue={buku.bahasa}>
            <SelectTrigger className="w-full border-none !text-xs">
      ...
      <main className='w-full flex items-center justify-between gap-x-4'>
        <div className='w-1/2 flex flex-col gap-y-1 mb-2'>
          ...
          <section className='flex items-center justify-center gap-x-2'>
            <Input defaultValue={buku.ukuranBuku.panjang} name='panjang' id='panjang' required className='w-full !text-xs placeholder:text-[10px] border-none' placeholder='Panjang Buku' />
            <Input defaultValue={buku.ukuranBuku.lebar} name='lebar' id='lebar' required className='w-full !text-xs placeholder:text-[10px] border-none' placeholder='Lebar Buku' />  
          </section>
        </div>
        ...
        <div className='w-1/2 flex flex-col gap-y-1 mb-2'>
          ...
          <Select name='sumberPengadaan' required defaultValue={buku.sumberPengadaan}>
            <SelectTrigger className="w-full border-none !text-xs">
...
export default DetailBukuInputContainerEdit