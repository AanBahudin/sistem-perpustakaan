...
const VerifikasiEmail = () => {
    ...
    useEffect(() => {
        store.dispatch(setVerifikasiEmail(initialParams))
    }, [])
    ...
    return (
        <section className="w-full mt-4">
            ...
            <ToggleGroup defaultValue={initialParams} value={verifikasiEmail} onValueChange={handleChange} type="single" className="flex gap-x-2 mt-4 w-full rounded-none flex-wrap">
