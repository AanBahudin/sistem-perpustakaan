...
const SemuaPenggunaSearchInput = () => {
    ...
    return (
        <section className='w-[40%] flex items-center border group px-2 rounded-lg gap-x-2 bg-accent/40'>
            ...
            <Input 
                ...
                placeholder='Cari pengguna berdasarkan atau NIM/NIDN...' />
