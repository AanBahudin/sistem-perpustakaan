                ...
                <TableBody>
                    {Array.from({ length: 10 }).map((_, index: number) => (
                        <TableRow key={index} className="border-accent-foreground/10 not-even:bg-accent-foreground/10">
                            ...
                            <TableCell className="w-[200px] text-xs">Judul Buku Contoh</TableCell>
                            <TableCell className="w-[120px] text-center text-xs">Fisik</TableCell>
                            <TableCell className="w-[120px] text-center text-xs">Dikembalikan</TableCell>
                            <TableCell className="w-[120px] text-center text-xs">Aan</TableCell>
                        </TableRow>
                    ))}
                </TableBody>
            </Table>
