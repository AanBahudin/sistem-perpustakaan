...
export const buatKondisi = async({denda, kondisi, userId} : BuatKondisiParamsType) => {
    ...
    const kondisiBaru = await Kondisi.create({kondisi, denda, createdBy: userId})
...
export const editKondisi = async({denda, kondisi, kondisiId} : EditKondisiParamsType) => {
